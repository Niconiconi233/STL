...
public:
	...
	set() :t(compare()) {}
	explicit set(const compare& com) :t(com) {}
	...
	*/
	...
	typedef std::pair<iterator, bool> pair_iteratoror_bool;
	std::pair<iterator, bool> insert(const value_type& x) {//first->iterator secound->true or false
	...
	pair<iterator, iterator> equal_rang(const key_type& x)const {
